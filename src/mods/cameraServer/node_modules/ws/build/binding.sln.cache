<Project DefaultTargets="Build" ToolsVersion="3.5" InitialTargets="ValidateSolutionConfiguration;ValidateToolsVersions" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'Win32') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{88EA4F05-FC9A-A5C1-A4E1-8D88362B4E19}">Debug|Win32</ProjectConfiguration>
        <ProjectConfiguration Project="{E1230990-DFCD-7796-DEBB-B3E65A1B1C46}">Debug|Win32</ProjectConfiguration>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'Win32') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{88EA4F05-FC9A-A5C1-A4E1-8D88362B4E19}">Release|Win32</ProjectConfiguration>
        <ProjectConfiguration Project="{E1230990-DFCD-7796-DEBB-B3E65A1B1C46}">Release|Win32</ProjectConfiguration>
      </SolutionConfiguration>
    </CurrentSolutionConfigurationContents>
  </PropertyGroup>
  ...
  <Target Name="bufferutil" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    ...
    <VCBuild Projects="D:\PHPnow-1.5.6\htdocs\playground\cameraServer\node_modules\ws\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|Win32" SolutionFile="D:\PHPnow-1.5.6\htdocs\playground\cameraServer\node_modules\ws\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'Win32') " />
    <CreateProperty Value="C:\Program Files\Microsoft Visual Studio 9.0\Common7\IDE\..\..\vc\vcpackages" Condition="'$(VCBuildToolPath)' == ''">
      <Output TaskParameter="Value" PropertyName="VCBuildToolPath" />
    </CreateProperty>
    <VCBuild Projects="D:\PHPnow-1.5.6\htdocs\playground\cameraServer\node_modules\ws\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|Win32" SolutionFile="D:\PHPnow-1.5.6\htdocs\playground\cameraServer\node_modules\ws\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'Win32') " />
  </Target>
  ...
  <Target Name="validation" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    ...
    <VCBuild Projects="D:\PHPnow-1.5.6\htdocs\playground\cameraServer\node_modules\ws\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|Win32" SolutionFile="D:\PHPnow-1.5.6\htdocs\playground\cameraServer\node_modules\ws\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'Win32') " />
    <CreateProperty Value="C:\Program Files\Microsoft Visual Studio 9.0\Common7\IDE\..\..\vc\vcpackages" Condition="'$(VCBuildToolPath)' == ''">
      <Output TaskParameter="Value" PropertyName="VCBuildToolPath" />
    </CreateProperty>
    <VCBuild Projects="D:\PHPnow-1.5.6\htdocs\playground\cameraServer\node_modules\ws\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|Win32" SolutionFile="D:\PHPnow-1.5.6\htdocs\playground\cameraServer\node_modules\ws\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" AdditionalLinkLibraryPaths="$(VCBuildAdditionalLinkLibraryPaths)" UseEnvironment="$(VCBuildUseEnvironment)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'Win32') " />
  </Target>
